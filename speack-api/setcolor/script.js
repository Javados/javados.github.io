...
// получаем наш звук
var successSound = document.getElementById('succes_sound');
...
recognition.onresult = function(event) {
  ...
  console.log(color);
  var colorsBox = document.getElementsByClassName('boxflex')[0];
  for (var i = 0; i < colorsBox.children.length; i++) {
    
    if (colorsBox.children[i].innerHTML.toLowerCase() == color.toLowerCase()) {
      successSound.play();
      colorsBox.children[i].style.display = "none";
    }
  }
