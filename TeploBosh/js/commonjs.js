jQuery(document).ready(function($){$(".bxslider, .bx-wrapper .bx-prev, .bx-wrapper .bx-next").mouseenter(function(){$(".bx-wrapper .bx-prev").css({"background-position":"0 0"});$(".bx-wrapper .bx-next").css({"background-position":"-43px 0"});})
